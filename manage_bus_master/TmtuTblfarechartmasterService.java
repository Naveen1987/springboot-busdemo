...
import com.tmtu.repositories.manage_bus_master.TmtuTblfarechartmasterRepository;
...
public class TmtuTblfarechartmasterService {
	...
	public List<Map<String, Object>> getallfarechart(){
		...
		tbIterable.forEach(record->{
			...
			bustype.put("bustypecode", record.getTlbbustypemaster().getServicetypeCode());
			bustype.put("bustypename", record.getTlbbustypemaster().getServiceTypeName());
