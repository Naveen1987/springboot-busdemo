...
public class TmtuTblconcessionmasterService {
	...
	public List<Map<String, Object>> findConcesssion(String concession){
		List<Map<String, Object>> listconcession=new ArrayList<Map<String, Object>>();
		List<Tblconcessionmaster> master=tmtuTblconcessionmasterRepository.findConcesssion(concession);
		master.forEach(record->{
			Map<String, Object> concessionJson=new HashMap<String, Object>();
			concessionJson.put("msg", "found");
			concessionJson.put("concessionid",record.getConcessionid());
			concessionJson.put("concessioncode", record.getConcessionCode());
			concessionJson.put("concessionname",record.getConcessionName());
			listconcession.add(concessionJson);
		});
		return listconcession;
	}
