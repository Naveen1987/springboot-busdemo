...
import com.tmtu.bus_master.services.TmtuTblbusmasterService;
...
public ResponseEntity<Map<String, String>> saveBus(
	...
	@GetMapping("/allbuses")
	public ResponseEntity<List<Map<String, Object>>> allBus(){
		Map<String, Object> json=new HashMap<String,Object>();
		List<Map<String, Object>> tblbusmaster =tmtuTblbusmasterService.findallBus();
		if(tblbusmaster.size()>0) {
			 return new ResponseEntity<List<Map<String, Object>>>(tblbusmaster, HttpStatus.OK);
			}
			else {
